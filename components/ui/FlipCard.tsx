...
export const FlipCard: FC<Props> = ({
  ...
  const { locale } = useRouter(); // Obtener idioma actual
          ...
          <div className={styles.flipCardBack}>
            <Col className={styles.innerFCB}>
              <ul className={styles.list}>
                <li>
                  <p style={{ fontSize: "100%" }}>
                    <strong>{locale === "en" ? "Category" : "Categoría"}:</strong>{" "}
                    {category}
                  </p>
                </li>
                ...
                <li style={{ fontSize: "100%" }}>
                  <p>
                    <strong>{locale === "en" ? "Client" : "Cliente"}:</strong>{" "}
                    {client}
                  </p>
                </li>
                <li style={{ fontSize: "100%" }}>
                  <p>
                    <strong>{locale === "en" ? "Project Date" : "Fecha del Proyecto"}:</strong>{" "}
                    {date}
                  </p>
                </li>
                <li style={{ fontSize: "100%" }}>
                  <p>
                    <strong>{locale === "en" ? "Duration" : "Duración"}:</strong>{" "}
                    {duration}
                  </p>
                </li>
                ...
                <Row>
                  <li>
                    <p>
                      <strong>{locale === "en" ? "Technologies" : "Tecnologías"}:</strong>{" "}
                    </p>
                  </li>
                  <Grid.Container>
                    {language.map((leng, idx) => (
                      <Grid key={idx} justify="center" xs={6} sm={4} lg={3}>
                        <Image
                          ...
                          width={50}
                          height={50}
                          alt={locale === "en" ? "Programming Languages" : "Lenguajes de Programación"}
                        />
                      </Grid>
                    ))}
                  </Grid.Container>
              ...
              >
                ...
                {description && (
                  <Tooltip title={locale === "en" ? "Description" : "Descripción"}>
                    <button
                      style={{
                        maxWidth: "40px",
                        width: "15vw",
              ...
              >
                ...
                >
                  <Typography
                    ...
                    component="h2"
                  >
                    {locale === "en" ? "About this work:" : "Acerca de este trabajo:"}
                  </Typography>
